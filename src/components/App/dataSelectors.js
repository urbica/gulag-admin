...
export const currentCampSelector = createSelector(campsSelector, currentIdSelector, (camps, id) =>
  camps.find(camp => camp.get('id') === parseInt(id, 10)));
...
export const currentNotesSelector = createSelector(notesSelector, currentIdSelector, (notes, id) =>
  notes.find(note => note.get('prison_id') === parseInt(id, 10)));
